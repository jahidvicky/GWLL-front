...
const AddOffers = () => {
    const { fetchalloffer, lowermanager, managerdata, fetchallmanager, fetchlowermanagerData } = useAuth();
    ...
    const handlesubmit = async (e, offer, superManagerEmail) => {
        ...
        try {
            ...
            await fetchalloffer(admintoken, lowermanagertoken, managertoken);
