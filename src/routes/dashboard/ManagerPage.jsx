...
const ManagerPage = () => {
    const { customersdata, employeedata, lowermanagerdata, fetchalluser, fetchallemployee, fetchallLowermanager } = useAuth();
    const managertoken = localStorage.getItem("managertoken");
    useEffect(() => {
        if (managertoken) {
            fetchalluser(managertoken);
            fetchallemployee(managertoken);
            fetchallLowermanager(managertoken);
        }
    }, [])
    return (
