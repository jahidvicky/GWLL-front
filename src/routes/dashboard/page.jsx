...
const DashboardPage = () => {
    const { customersdata, employeedata, managerdata, lowermanagerdata, fetchalluser,fetchallemployee,fetchallLowermanager,fetchallmanager } = useAuth();
    const admintoken = localStorage.getItem("admintoken");
    useEffect(() => {
        if (admintoken) {
            fetchalluser(admintoken);
            fetchallemployee(admintoken);
            fetchallLowermanager(admintoken);
            fetchallmanager(admintoken);
        }}, []);
    return (
