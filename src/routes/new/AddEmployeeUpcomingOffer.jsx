...
const AddEmployeeUpcomingoffer = () => {
    const { fetchemployeeallupcomingoffer, lowermanager, managerdata, fetchallmanager, fetchlowermanagerData } = useAuth()
    ...
    const handlesubmit = async (e, offer, superManagerEmail) => {
        ...
        try {
            ...
            await fetchemployeeallupcomingoffer(admintoken, lowermanagertoken, managertoken);
